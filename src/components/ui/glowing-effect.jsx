      ...
      <>
        <div
          style={{
            ...
            border: variant === "white" ? "1px solid white" : "1px solid rgba(255,255,255,0.1)",
            opacity: glow ? 1 : 0,
        ...
        <div
          ...
          style={{
            ...
            inset: 0,
            borderRadius: "inherit",
            opacity: 1, // Base opacity (glow applies to border)
            transition: "opacity 0.3s ease",
            filter: blur > 0 ? `blur(var(--blur))` : "none",
            display: disabled ? "none" : "block",
            // The className is applied for potential external style overrides
          }}
          className={className}
        >
          {/* This inner div perfectly matches the `after:` tailwind pseudo-element */}
          <div
            style={{
              position: "absolute",
